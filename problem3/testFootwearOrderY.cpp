...
Total: $135.00\n";
	...
	GetCreative* item10 = new GetCreative("Adidas");
	item10->addAccessory("socks");
	item10->addAccessory("shoe polish");
	item10->addAccessory("socks");
	order4.addItem(item10);
	PreMadeDeal* item8 = new PreMadeDeal("Fila Package", "Fila");
...
Total: $135.00\n";
	...
	FootwearOrder order5;
	expected = "Total: $0.00\n";
	ASSERT_EQUALS(expected, order5.printBill());


	FootwearOrder order6;
	GetCreative *item11 = new GetCreative("Fila");
	GetCreative *item12 = new GetCreative("Adidas");
	order6.addItem(item11);
	order6.addItem(item12);
	expected = 
"GetCreative Brand: Fila\n\
Accessories:\n\
Price: $30.00\n\
...
Total: $65.00\n";
	...
	ASSERT_EQUALS(expected, order6.printBill());


	item11->addAccessory("asdf");
	item11->addAccessory("qwer");
	item11->addAccessory("asdf");
	item11->addAccessory("qwer");
